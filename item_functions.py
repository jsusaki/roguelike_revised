...
def heal(*args, **kwargs):
    ...
    if entity.fighter.hp == entity.fighter.max_hp:
        ...
        results.append({'consumed': True, 'message': Message('Your wounds starts to cure.', libtcod.green)})
...
def cast_confuse(*args, **kwargs):
    ...
    for entity in entities:
        if entity.x == target_x and entity.y == target_y and entity.ai:
            ...
            results.append({'consumed': True, 'message': Message('The eyes of the {0} look vacant, ashe starts to stumble around.'.format(entity.name), libtcod.light_green)})
